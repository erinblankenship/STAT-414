...
- Lohr, S. (2022) Sampling Design and Analysis, 3$^{rd}$\$\^{rd}\$\$\^{rd}\$\$\^{rd}\$ edition. A digital version of the textbook will be linked through Canvas as part of a UNL textbook project, and the cost of the book will added to your student account.
